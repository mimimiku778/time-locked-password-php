...
class ViewState
{
     ...
     */
    public function handleDecryption(string $encryptedData, ?string $unlockTimeFromUrl = null): void
    {
        $firstError = null;

        foreach ($this->passwordManagers as $manager) {
            $result = $manager->decryptPassword($encryptedData, $unlockTimeFromUrl);
